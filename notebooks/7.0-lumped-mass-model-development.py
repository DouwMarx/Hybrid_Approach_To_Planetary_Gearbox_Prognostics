...
#t = np.linspace(0, 2*10**7, 3)#int(1e2))

#plt.figure()
#plt.plot(t,ke1.k_sp(t))
#t = np.linspace(0, 10, int(1e6))

#X0new = np.zeros((9+ N*3)*2 - 6)
#X0new[0] = 0.0000001

# d1 = DE_Integration(PG)
# #d2 = DE_int(0, 4, 3, 2)
#
# #E, Q = d1.E_Q(3)
#
